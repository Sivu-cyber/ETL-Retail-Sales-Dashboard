...
UNION ALL SELECT 'dw.DimCustomer', COUNT(*) FROM dw.DimCustomer
UNION ALL SELECT 'dw.DimProduct', COUNT(*) FROM dw.DimProduct
UNION ALL SELECT 'dw.DimDate', COUNT(*) FROM dw.DimDate
UNION ALL SELECT 'dw.FactSales', COUNT(*) FROM dw.FactSales
UNION ALL SELECT 'stg.RejectedSales', COUNT(*) FROM stg.RejectedSales;
...
-- SCD Type 2 history
SELECT CustomerID, CustomerName, City, EffectiveDate, EndDate, IsCurrent
FROM dw.DimCustomer
